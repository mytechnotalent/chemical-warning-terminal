 ...
 *
 * DESCRIPTION:
 * Host mock header for the FROSTLINE chemical warning beacon CoreDebug and
 * reserved flash accesses so the anti-debug, sabotage marker, and
 * persistence paths are testable.
 *
 * BRIEF:
...
/**
 * @brief Seed the mock reserved-sector sabotage marker.
 *
 * @param void No parameters.
 * @return void
 */
static inline void mock_implant_seed_marker(void) {
    g_mock_implant_flash = 0x58u;
}

/**
 * @brief Clear the mock reserved-sector sabotage marker.
 *
 * @param void No parameters.
 * @return void
 */
